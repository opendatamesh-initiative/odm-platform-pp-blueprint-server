...
| [Protected resources](service/protected-resources.md) | Destination-scoped paths, root shorthand, parent-only ownership, and publication checks across all repository layouts |
