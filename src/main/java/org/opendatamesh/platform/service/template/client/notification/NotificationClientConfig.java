...
import org.opendatamesh.platform.service.template.utils.client.RestUtilsFactory;
...
public class NotificationClientConfig {
    ...
    @Value("${service-template.observer.name:service-template}")
    private String observerName;
    @Value("${service-template.observer.displayName:Service template}")
