package org.opendatamesh.platform.service.template.rest;

import org.opendatamesh.platform.service.template.exceptions.*;
import org.opendatamesh.platform.service.template.rest.v2.resources.ErrorRes;
...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ServiceTemplateApiException.class})
    protected ResponseEntity<Object> handleServiceTemplateApiException(ServiceTemplateApiException e, WebRequest request) {
    ...
    protected ResponseEntity<Object> handlePropertyReferenceException(PropertyReferenceException e, WebRequest request) {
        ...
        return handleServiceTemplateApiException(badRequestException, request);
    }
