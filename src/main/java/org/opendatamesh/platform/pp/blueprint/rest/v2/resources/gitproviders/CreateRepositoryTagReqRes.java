...
/**
 * Request body to create a Git tag on a provider repository and push it to the remote (local clone via git-utils).
 */
@Schema(name = "create_repository_tag_command", description = "Command to create a tag on the remote repository via a local clone")
public class CreateRepositoryTagReqRes {
