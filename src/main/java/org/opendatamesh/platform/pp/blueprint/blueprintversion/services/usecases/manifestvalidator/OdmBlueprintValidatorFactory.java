...
@Component
public class OdmBlueprintValidatorFactory {

    public ManifestValidator getManifestValidator(String manifestSpec, String manifestSpecVersion) {
        ...
        if (manifestSpec.equalsIgnoreCase(ManifestSpec.ODM_BLUEPRINT_MANIFEST.getSpec()) && manifestSpecVersion.matches("1\\..*")) {
            return new OdmBlueprintManifestValidator();
        }
