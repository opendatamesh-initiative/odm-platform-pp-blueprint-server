...
import org.opendatamesh.platform.service.template.OdmPlatformServiceTemplateApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {OdmPlatformServiceTemplateApplication.class, TestContainerConfig.class, TestConfig.class})
public abstract class OdmPlatformServiceApplicationIT {
