...
import org.opendatamesh.platform.pp.blueprint.BlueprintApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {BlueprintApplication.class, TestContainerConfig.class, TestConfig.class})
public abstract class BlueprintApplicationIT {
